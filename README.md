...
En el proceso de pruebas de regresión Visual se utilizaron las herramientas Puppeteer y Resemble JS sobre la plataforma Ghost en sus versiones 3.3.0 y 3.42.5.
...
### Iteración 1 sobre Ghost 3.3.0

#### Instalación:

Una vez se clona el repositorio es necesario instalara las librerías necesarias para su funcionamiento. Para ello ubiquese en la carpeta "prueba/04_regresion_visual/puppeteer_3.3.0/" y ejecute el siguiente comando:
...
Los resultados obtenidos de la ejecución de pueden observar por la consola y en la generación de imágenes PNG guardadas en la carpeta "prueba/04_regresion_visual/puppeteer_3.3.0/images". El nombre de cada imágen contiene el escenario de prueba (EP) a la cual pertenece, las funcionalidades que hacen parte del escenario de pruebas, indice y nombre de la funcionalidad específica probada e índice interno de los pasos dentro de la funcionalidad.
...
### Iteración 2 sobre Ghost 3.42.5

#### Instalación:

Una vez se clona el repositorio es necesario instalara las librerías necesarias para su funcionamiento. Para ello ubiquese en la carpeta "prueba/04_regresion_visual/puppeteer_3.42.5/" y ejecute el siguiente comando:
...
Los resultados obtenidos de la ejecución de pueden observar por la consola y en la generación de imágenes PNG guardadas en la carpeta "prueba/04_regresion_visual/puppeteer_3.42.5/images". El nombre de cada imágen contiene el escenario de prueba (EP) a la cual pertenece, las funcionalidades que hacen parte del escenario de pruebas, indice y nombre de la funcionalidad específica probada e índice interno de los pasos dentro de la funcionalidad.
...
Una vez se clona el repositorio es necesario instalara las librerías necesarias para su funcionamiento. Para ello ubiquese en la carpeta "prueba/04_regresion_visual/resemble.js/" y ejecute el siguiente comando:
...
Para poder ejecutar el proceso visual comparativo se debe seguir los siguientes pasos:

1. Ubicarse en la carpeta "prueba/04_regresion_visual/resemble.js/" y ejecutar el comando: `node ./src/index.js`
